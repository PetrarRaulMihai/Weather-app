...
function Main() {
  ...
  const [latitude, setLatitude] = useState(46.7712);
  const [longitude, setLongitude] = useState(23.6236);
  ...
  const getCoords = async () => {
    const cityUrl = `https://api.openweathermap.org/geo/1.0/direct?q=${cityName}&appid=${mainApi}`;
